...
CEO_sample <- merge(CEO_sample, CEOfull[,c('ID',"WATER", "AQUACULTUREPOND", "AQUATICVEGOTHER", 
                                           "BARRENOTHER", "MINING", "MUDFLATBEACH", 
                                           "BUILTSURFACE","BUILTTREE", "BUILTVEGNONTREE", 
                                           "CROP", "GRASS", "SHRUB", "OTHER", 
                                           "SNOWICE", 
                                           "TREEOTHER", "TREEPLANTATIONORCHARD", "TREEMANGROVE", "UNKNOWN")], by.x = 'ID', by.y = 'ID')

boxplot(ydata ~ partition, data=CEO_sample, main="", 
        col = 'blue', xlab=xlabel, ylab=ylabel)
